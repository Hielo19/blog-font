...
/* oxlint-disable jsx-a11y/prefer-tag-over-role -- These wrappers group arbitrary controls and addons rather than defining a form fieldset. */
...
function InputGroupAddon({
  ...
  return (
    // Clicking the addon only forwards focus to the input, which already has its own keyboard tab stop.
